...
enum BarcodeFormat {}
const BarcodeScannerPlugin: any = { scan: () => ({ barcodes: [] }), addListener: () => {}, removeAllListeners: () => {}, stopScan: () => {} };
type GoogleBarcodeScannerModuleInstallProgressEvent = any;
enum GoogleBarcodeScannerModuleInstallState { COMPLETED, FAILED, CANCELED }
const Capacitor: any = { isPluginAvailable: () => false, isNativePlatform: () => false, getPlatform: () => 'web' };
