...
// Build-time flag injected by webpack DefinePlugin (--env demo → true).
// Tells the app to skip all backend checks and use seeded localStorage data.
...
const PreInit: React.FC<React.PropsWithChildren> = ({ children }) => {
  // In demo mode, skip the server initialisation check entirely — the app
  // is already seeded with a fake auth state, and there's no server to query.
 ...
 * conditions.
 */
// Screen orientation lock removed for web demo
